                              ...
                              itemBuilder: (ctx, i) => GestureDetector(
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            InkWell(child: const Text("FB Profile:", style: TextStyle(color: Colors.blue),), onTap:() {
                                              if(myShiftsList[i].fbProfile.contains("https://www.")){
                                                launchUrl(Uri.parse(myShiftsList[i].fbProfile)); 
                                              }else{
                                                launchUrl(Uri.parse("https://www.${myShiftsList[i].fbProfile}"));
                                              }
                                            })
                                          ],
                                        ),
                                      ...
                                      onTap: () {
                                        showDialog(
                                          context: context,
                                          builder: (context) {
                                            return AcceptAlertDialog('Info',
                                              'What do you want to perform with this application', onAccept: () {
                                                _dbConnectApplications.acceptApplication(widget.shiftId, myShiftsList[i].id!, myShiftsList[i].applicantId);
                                              }, onReject: () {
                                                 _dbConnectApplications.rejectApplication(widget.shiftId, myShiftsList[i].id!, myShiftsList[i].applicantId);
                                              },);
                                        });
                                      },
                                    )
